...
// Extend THREE namespace for the custom material
declare global {
  namespace JSX {
...
function Scene({ 
  ...
  useEffect(() => {
    dotMaterial.uniforms.dotColor.value.setStyle(dotColor)
    dotMaterial.uniforms.bgColor.value.setStyle(bgColor)
    dotMaterial.uniforms.dotOpacity.value = dotOpacity
    dotMaterial.uniforms.gridSize.value = gridSize
  }, [dotMaterial, dotColor, bgColor, dotOpacity, gridSize])
